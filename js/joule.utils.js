    ...
    updater: function(treeObj, plotLineDesc, expand) {
        ...
        if (treeObj.hasOwnProperty("children")) {
            if (typeof expand == 'boolean' && !expand) {
                ...
                treeObj._children.forEach(function(v) {
                    utils.updater(v, plotLineDesc, false);
                });
            }
            else
                treeObj.children.forEach(function(v) {
                    utils.updater(v, plotLineDesc, expand);
                });
        }
            ...
            if (typeof expand == 'boolean' && expand) {
                ...
                treeObj.children.forEach(function(v) {
                    utils.updater(v, plotLineDesc, true);
                });
            }
            else
                treeObj._children.forEach(function(v) {
